# agent_logic.py
# This file contains the core logic tools for the RAG agent.
...
# --- Tool from ExpandQueryTool.py ---
@tool
def expand_query_tool(llm, query: str) -> Dict[str, Any]:
    """
...
# --- Tool from RouteQueryTool.py ---
@tool
def route_query_tool(state: RagState, llm: Any) -> Dict[str, Any]:
    """
...
# --- Tool from HandleFollowUpTool.py ---
@tool
def handle_follow_up_tool(state: RagState) -> Dict[str, Any]:
    """
    후속 질문 처리, 상태 변경 없이 기존 retrieved_docs 사용. (의도적인 No-Op)
    """
    return {}

# --- Tool from SummarizeTool.py ---
@tool
def summarize_tool(llm: Any, query: str, retrieved_docs: List[Dict[str, Any]]) -> Dict[str, Any]:
    """
